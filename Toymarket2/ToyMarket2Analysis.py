...
loader = importlib.machinery.SourceFileLoader('LoadToymarket2Data', 'LoadToymarket2Data.py')
LoadToymarket2Data = loader.load_module()

figurePrefix = "figures/ToyMarket2_"
...
if __name__ == "__main__":  # Multithreaded functions
    SimOrderBooks, AgentLogs, RT_CashInventory, TradesLogs = LoadToymarket2Data.GetData("data/")
    AgentNames = LoadToymarket2Data.GenerateAgentNames(10,100, "RT")
