...
from Inv_MarketMaker import Plot_LOHitTime
from Plot_Volatility import MakeVolatilityPlot, MakeVolatilityDistributionPlot

loader = importlib.machinery.SourceFileLoader('LoadSPYData', 'LoadSPYData.py')
LoadSPYData = loader.load_module()
...
# Make plot of the mid price
    time_window = [pd.Timestamp("2018-02-06 9:30:00", tz = "America/New_York"), pd.Timestamp("2018-02-06 16:00:00", tz = "America/New_York")]
    MidPriceFigure = MakeMidPricePlot(SimOrderBooks, time_window= time_window)
   # MidPriceFigure.savefig(figurePrefix+"Midprice.png")

# # Make plot of volatility and volatility distribution
#
    VolatilityFigure = MakeVolatilityPlot(SimOrderBooks, time_window=time_window)
